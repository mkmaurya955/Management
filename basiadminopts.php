...
<ul class="nav  nav-justified" style="background-color:#FFF;">
  <li  style="font-family:calibri; font-size:16px;"><a style="color:#000" href="supadmopt.php"><strong>Admin</strong></a></li>
  <li class="active" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="basiadminopts.php"><strong>Members</strong></a></li>
</ul>
</div></div>
<hr>
<div class="container-fluid">
...
<ul class="nav  nav-justified" style="background-color:#FFF;">
  <li class="active" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="basiadminopts.php"><strong>Insert Members Details</strong></a></li>
  <li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="deletesbsad.php"><strong>Delete Members Details</strong></a></li>
</ul>
<hr>
</div></div>
...
<div class="alert alert-danger col-md-4 col-md-offset-4 col-xs-12 text-center">This registration form creates only Members Accounts.</div></div>
<div class="container">
<div class="row">
<div class="col-md-4 col-md-offset-4 col-xs-12">
<div class="panel panel-default">
<div class="panel-heading text-center">Members Registration Form</div>
